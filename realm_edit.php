...
if (isset($_POST['update_button'])) {
   //update action
   $operation = "update";
   $query = "UPDATE Realm SET Location='$location', Language='$language', Difficulty='$difficulty' WHERE realmid='$realmid'";
...
$conn = mysql_connect($bclabre_1, $username, $password);
   ...
   header("Location: realm.html?operation=$operation&status=$status#searchForm");
?>
</body>
</html>
